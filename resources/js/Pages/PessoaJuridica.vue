                    ...
                    <div class='row col-md-6'>
                        ...
                        <form action='' id='frm-pessoa-juridica' name='frm-pessoa-juridica' method='POST'>
                            ...
                            <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                ...
                                <v-select v-model="tipos.tipo_empresa" class='select-text block w-full bg-gray-50 text-gray-700 border border-blue-50 rounded py-3 px-4 mb-3 leading-tight focus:text-blue-500 focus:bg-white'
                            ...
                            <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                ...
                                <input name='fk_id_tipo_estabelecimento' id='fk_id_tipo_estabelecimento' type='text' placeholder='Escolha o tipo de empresa' class='appearance-none block w-full bg-gray-50 text-gray-700 border border-blue-50 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white'>
                            ...
                            <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                ...
                                <input name='capital_social' id='capital_social' type='text' placeholder='Escolha o tipo de empresa' class='appearance-none block w-full bg-gray-50 text-gray-700 border border-blue-50 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white'>
                            ...
                            <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                ...
                                <input name='dt_ultima_alt_capital' id='dt_ultima_alt_capital' type='text' placeholder='Escolha o tipo de empresa' class='appearance-none block w-full bg-gray-50 text-gray-700 border border-blue-50 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white'>
                            ...
                            <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                ...
                                <input name='nr_ultima_alt_contratual' id='nr_ultima_alt_contratual' type='text' placeholder='Escolha o tipo de empresa' class='appearance-none block w-full bg-gray-50 text-gray-700 border border-blue-50 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white'>
