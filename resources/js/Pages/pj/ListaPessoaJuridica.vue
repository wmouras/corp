                ...
                <div class='bg-white overflow-hidden shadow-xl sm:rounded-lg'>
                    ...
                    <div class='row col-md-6 flex inline'>
                        ...
                        <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                            ...
                            <input v-model="pesquisa.nome_fantasia" id='nome_fantasia' name='nome_fantasia' type='text' placeholder='Insira o nome fantasia'
                        ...
                        <div class='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                            ...
                            <input v-model="pesquisa.razao_social" name='razao_social' id='razao_social' type='text' placeholder='Insira a razão social'
                                class='appearance-none block w-65 bg-gray-50 text-gray-700 border border-blue-50 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white'>
            ...
            <div class='max-w-7xl mx-auto sm:px-6 lg:px-8' id="div_1" ref="divDescricao">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <td class="border-t w-px">
                        <a class="px-6 py-4 flex items-center cursor-pointer" @click="editarPessoaJuridica(pj.fk_id_pessoa)" tabindex="-4">
                        Editar
                        </a>
                    </td>
                    </tr>
...
<script>
    ...
    export default {
       name: 'ListaPessoaJuridica',
        ...
        methods: {
            editarPessoaJuridica: function (id_pessoa){
                window.location.assign('/pj/pessoajuridica/dados/'+id_pessoa)
            }
        }
